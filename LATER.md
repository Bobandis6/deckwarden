...
| Tag-editing UI in the editor (entries carry `tags text[]`; P1.3's tag grouping renders an honest "Untagged" bucket but nothing can set tags yet) | First editor session of M2. **P2.2 (2026-08-30) explicitly ruled itself out**: profiles/folders never opened the editor surface (`src/components/editor/*` untouched — folder assignment lives on /account). Likely first firing: P2.7 (sample hand + deck notes). |
